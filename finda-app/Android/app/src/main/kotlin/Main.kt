...
internal val logger: SkipLogger = SkipLogger(subsystem = "finda.module", category = "FINDA")

private typealias AppRootView = FINDARootView
private typealias AppDelegate = FINDAAppDelegate
...
open class MainActivity: AppCompatActivity {
    ...
    override fun onCreate(savedInstanceState: android.os.Bundle?) {
        ...
        ActivityCompat.requestPermissions(this, kotlin.arrayOf(Manifest.permission.CAMERA), 1001)
    }
